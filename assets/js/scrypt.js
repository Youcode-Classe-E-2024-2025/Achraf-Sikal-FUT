...
players.forEach(player => {
    if(player.position !=="GK"){
        document.getElementById("playerSelect").innerHTML +=`<button class=""><div class="bg-[url('/assets/images/badge_total_rush.webp')] bg-cover bg-no-repeat w-40 h-52 justify-items-center pl-3 pr-3 pt-7 pb-2"  id="card">
        <div class="flex ">
